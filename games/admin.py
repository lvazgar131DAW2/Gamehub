...
class GameAdmin(admin.ModelAdmin):
    ...
    trailer_preview.short_description = 'Preview Trailer'
    ...
    def mark_as_featured(self, request, queryset):
        ...
        self.message_user(
            request,
            f'{count} juego{"s" if count != 1 else ""} seleccionado{"s" if count != 1 else ""}'
        )
    ...
    def clear_image(self, request, queryset):
        ...
        self.message_user(
            request,
            f'Imagen eliminada de {count} juego{"s" if count != 1 else ""}'
        )
